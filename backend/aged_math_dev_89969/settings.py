"""
Django settings for aged_math_dev_89969 project.
...
ROOT_URLCONF = 'aged_math_dev_89969.urls'
...
WSGI_APPLICATION = 'aged_math_dev_89969.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_math_dev_89969 API",
    "DESCRIPTION": "API documentation for aged_math_dev_89969 App",
    "VERSION": "v1",
}
